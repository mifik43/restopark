...
from menu_data import MENU  # импорт готового словаря из menu_data.py

def seed():
    with app.app_context():
        # Очищаем только меню, заказы и сессии не трогаем
        print("Очистка старых категорий и блюд...")
        ...
        for slug, cat_data in MENU.items():
